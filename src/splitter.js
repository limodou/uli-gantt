...
$.fn.splitter = function(args){
	...
	return this.each(function() {
		...
		var opts = $.extend({
			...
			barNormalClass: "splitter-bar-default",			// splitbar normal
			barHoverClass:  "splitter-bar-hover",			// splitbar mouse hover
			barActiveClass: "splitter-bar-highlight",		// splitbar being moved
			barLimitClass:  "splitter-bar-error",			// splitbar at limit
