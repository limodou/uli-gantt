    ...
    //    var a = this.serializeArray();
        $(el).find('input, select, textarea').each(function() {
            ...
            if ($this.is('select')) elemValue = $this.find('option:selected').val();
                ...
                if ($this.prop('checked')) elemValue = this.value;
                return ;
            }
    ...
    $.fn.editable = function(target, options) {
        ...
        return this.each(function() {
            ...
            $(this).bind(settings.event, function(e) {
                ...
                settings.width = settings.width - settings.width_offset;
                settings.height = settings.height - settings.height_offset;
                    ...
                    if (false !== onsubmit.apply(form, [settings, self])) { 
                        ...
                        if (false !== submit.apply(form, [settings, self])) { 
                          ...
                          if ($.isFunction(settings.target)) {
                              ...
                              $(self).html(str);
                              self.editing = false;
                              callback.apply(self, [{success:true, data:input_val}, settings]);
                              ...
                              //using serializeObject to get real form data, in order to
    ...
    $.editable = {
        types: {
            ...
            bool: {
                ...
                content: function(string, settings, original){
                    $(':input:first', this).prop('checked', string);
                }
            },
            select: {
               element : function(settings, original) {
